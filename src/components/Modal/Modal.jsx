      ...
      <div className="modal-background">
        <div className="modal-container">
          ...
          <div className="modal-img">
            <img src={singleEvent.image} alt="" style={{ width: '550px', height: 'auto' }} />
          </div>
          ...
          <div className="modal-info">
            ...
            <div className="modal-event-size">
              {singleEvent.event_size === "small" ? (
                <span className="small-event">Small</span>
              ) : singleEvent.event_size === "medium" ? (
                <span className="medium-event">Medium</span>
              ) : (
                <span className="large-event">Large</span>
              )}
            </div>
            ...
            <div className="modal-website">
              <a href={`${singleEvent.website}`} target="_blank">
                Event Link
              </a>
            </div>
          </div>
